...
void PerftTesting::testAllPos(int n) {
    ...
    for (int runs = 0; runs < n; runs++) {
        ...
        std::vector<U64> expected = {119060324ull, 193690690ull,  178633661ull,
                                     706045033ull, 89941194ull,   164075551ull,
                                     71441619ull,  2261050076ull, 437319625ull};
        ...
        std::cout << "Correct Positions  : " << passed << "/"
                  << expected.size() + expected960.size() << std::endl;
    }
