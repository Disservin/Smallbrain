...
int16_t INPUT_WEIGHTS[BUCKETS * FEATURE_SIZE * N_HIDDEN_SIZE];
int16_t HIDDEN_BIAS[N_HIDDEN_SIZE];
...
void init(const char *filename) {
    ...
    // obtain file size
    int fileSize = FEATURE_SIZE * N_HIDDEN_SIZE + N_HIDDEN_SIZE + 2 * N_HIDDEN_SIZE + OUTPUTS;
